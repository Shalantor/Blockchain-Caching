...
public class AverageTransactionsTestModule {
        ...
        for(int j = 0; j < 10; j++){
            ...
            for(Node n : nodes){
                if(n instanceof NormalNode){
                    ...
                    count = ((NormalNode) n).cacheManager.interestingTransactions;
                    allCount = ((NormalNode) n).cacheManager.overallTransactions;
                    ...
                    count = ((LightNode) n).cacheManager.interestingTransactions;
                    allCount = ((LightNode) n).cacheManager.overallTransactions;
                    hitRate += (1.0f*count) / allCount;
